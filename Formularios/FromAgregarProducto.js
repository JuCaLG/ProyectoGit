...
export default function FromAgregarProducto(props, navigation) {
        ...
        <ScrollView
            ...
            <View style={[mainStyles.container, { padding: 50 }]}>
                ...
                <MyTextInput placeholder='Nombre' image='user'
                    value={fecha} onChangeText={nombre => guardarNombre(nombre)} />
                ...
                <View>
                    ...
                    >
                        ...
                        <Picker.Item label="Ferreteria" value="Ferreteria" />
                        <Picker.Item label="Agricultura" value="Agricultura" />
                        <Picker.Item label="Textiles" value="Textiles" />
                    </Picker>
                </View>
                <View>
                    <Text style={{ fontWeight: 'bold', fontSize: 22, marginTop: 20 }}>       Seleccione producto         </Text>
                    <Picker
                        selectedValue={selectedValue}
                        style={{ height: 50, width: 300 }}
                        onValueChange={(itemValue, itemIndex) => setSelectedValue(itemValue)}
